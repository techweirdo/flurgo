...
(function (window, document) {
  ...
  ShareBar.prototype = {
    ...
    mergeOptions: function mergeOptions(options) {
      var option,
        defaultOptions = {
          ...
          onCreateButton: function (button) {
            return false;
          },
      ...
      for (i; i < networks.length; i++) {
        if (typeof networks[i] === "string") {
          ...
          if (method) {
            ...
            console.log("err creating method");
            throw new Error(
              msg +
                ' [Network name "' +
                networks[i] +
          ...
          console.log("err creating function");
    ...
    getButtonsSmall: function getButtonsSmall(
      numberOfButtons,
      smallButtonWidth,
      containerWidth
    ) {
    ...
    getButtonsFull: function getButtonsFull(
      numberOfButtons,
      fullButtonWidth,
      smallButtonWidth,
      containerWidth
    ...
    getMetadataFromElement: function getMetadataFromElement(element) {
      var encode = window.encodeURIComponent,
        ...
        splitUrl = url.split("#"),
        queryString =
          "?utm_source=#source#&utm_medium=share-bar-" +
          this.context +
          "&utm_campaign=" +
          this.campaign;
    ...
    createButton: function createButton(
      ...
      className = className || "";
      shareContainer.className =
        SHARE_BUTTON + " share-" + socialNetworkClass + className;
      socialNetworkTitle =
        socialNetworkTitle[0].toUpperCase() + socialNetworkTitle.slice(1);
    ...
    createFacebookButton: function createFacebookButton(
      container,
      buttonClass
    ) {
      var onShare = "",
      ...
      button = this.createButton(
        ...
        FACEBOOK,
        buttonClass,
        "https://www.facebook.com/TeamFlurgo/",
        "",
        true
      );
    ...
    createInstagramButton: function createLinkedinButton(
      container,
      buttonClass
    ) {
      var data = this.getMetadataFromElement(container);
      ...
      this.createButton(
        ...
        INSTAGRAM,
        buttonClass,
        "https://instagram.com/teamflurgo?igshid=1eylr4y3ad2fa"
      );
    },

    createLinkedinButton: function createLinkedinButton(
      container,
      buttonClass
    ) {
      var data = this.getMetadataFromElement(container);
      ...
      this.createButton(
        ...
        LINKEDIN,
        buttonClass,
        "https://www.linkedin.com/company/flurgo/"
      );
    },

    createPinterestButton: function createPinterestButton(
      container,
      buttonClass
    ) {
      var data = this.getMetadataFromElement(container);
    ...
    createWhatsappButton: function createWhatsappButton(
      container,
      buttonClass
    ) {
      var data = this.getMetadataFromElement(container);
    ...
    createTelegramButton: function createTelegramButton(
      container,
      buttonClass
    ) {
      var data = this.getMetadataFromElement(container);
